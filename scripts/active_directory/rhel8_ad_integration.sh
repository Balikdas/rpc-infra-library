...
echo 'Starting RHEL8 AD integration...'

# This procedure only for RHEL8
grep 'Red Hat Enterprise Linux release 8' /etc/redhat-release
if [[ $? -ne 0 ]]; then
  echo "This script is only for RHEL 8.x. Terminating"
  exit 1
fi
